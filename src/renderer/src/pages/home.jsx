  ...
  return (
    <section className="relative min-h-screen flex items-center bg-cream overflow-hidden">
      ...
      <div className="home-text relative z-10 px-8 md:px-24 max-w-2xl">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur border border-main/20 mb-6">
          <span className="h-2.5 w-2.5 rounded-full bg-green-500 animate-pulse"></span>
          <span className="text-sm font-medium text-main">{heroContent.badge}</span>
        </div>
